...
class ProjetosControllerTest < ActionController::TestCase
  ...
  test "should create projeto" do
    assert_difference('Projeto.count') do
      post :create, projeto: { data_inicio: @projeto.data_inicio, descricao: @projeto.descricao, nome: @projeto.nome, status: @projeto.status }
    end
  ...
  test "should update projeto" do
    patch :update, id: @projeto, projeto: { data_inicio: @projeto.data_inicio, descricao: @projeto.descricao, nome: @projeto.nome, status: @projeto.status }
    assert_redirected_to projeto_path(assigns(:projeto))
  end
